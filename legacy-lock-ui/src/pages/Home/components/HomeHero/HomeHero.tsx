    ...
    <div className={heroContainerClasses}>
      <div className={styles.heroSectionTop}>
        <div className={styles.heroSectionTopContent}>
          <h1 className={styles.heroTitle}>Legacy Lock Vault</h1>

          <p className={styles.heroDescription}>
            A decentralised time-locked escrow on MultiversX. Lock your xEGLD
            and unlock it only after your chosen duration has passed.
          </p>
        </div>
